      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <AdminPanel title="Camps" eyebrow="SUMMER_BASELINE">
            <dl className="space-y-2 font-mono text-[11px] text-zinc-300">
              <div className="flex justify-between">
                <dt className="text-zinc-500">Summer baseline</dt>
              ...
              <div className="flex justify-between">
                <dt className="text-zinc-500">Membership conversion</dt>
          ...
          <AdminPanel title="Tournaments" eyebrow="CYCLE">
            <dl className="space-y-2 font-mono text-[11px] text-zinc-300">
              <div className="flex justify-between">
                <dt className="text-zinc-500">Per 12-week cycle</dt>
            ...
            <p className="mt-2 font-mono text-[10px] text-zinc-500">Parking flow + bracket timing: ops checklist (TBD).</p>
          </AdminPanel>
          <AdminPanel title="Parties" eyebrow="FIXED_WINDOWS">
            <dl className="space-y-2 font-mono text-[11px] text-zinc-300">
              <div className="flex justify-between">
                <dt className="text-zinc-500">Fixed windows</dt>
                <dd>{e.parties.fixedWindows}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">This month</dt>
          ...
          <AdminPanel title="Footbot" eyebrow="SUNDAY">
            <dl className="space-y-2 font-mono text-[11px] text-zinc-300">
              <div className="flex justify-between">
                <dt className="text-zinc-500">Standalone</dt>
                <dd>{e.footbot.sundayStandalone ? 'Yes' : 'No'}</dd>
              </div>
              <div className="flex justify-between">
                <dt className="text-zinc-500">Next slot</dt>
