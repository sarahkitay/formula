...
function CoachObservationsInner() {
  ...
  const [playerId, setPlayerId] = React.useState(pre ?? 'player-1')
  ...
  <CoachGuardrailsStrip items={[coachGuardrails[2], coachGuardrails[3]]} />
  ...
  <p className="mt-2 font-mono text-[11px] text-zinc-400">Youth block · station / Friday circuit / clinic (demo)</p>
  </div>
  </div>
