...
export const facilityAssets: FacilityAsset[] = [
  ...
  {
  id: 'match-arena',
  label: 'Match Arena / Proving Ground',
  shortLabel: 'Arena',
  status: 'in-use',
  utilizationPct: 76,
  ...
  status: 'in-use',
  utilizationPct: 55,
  currentProgram: 'Cognitive drill queue',
  nextProgram: 'Reset',
  load: 0.55,
  },
  {
  ...
  utilizationPct: 22,
  currentProgram: '-',
  nextProgram: 'Strength micro-block',
  load: 0.22,
  },
  {
  id: 'flex-room',
  ...
  status: 'reserved',
  utilizationPct: 40,
  currentProgram: 'Staff briefing',
  nextProgram: 'Video review',
  load: 0.4,
  },
  {
  id: 'party-room',
